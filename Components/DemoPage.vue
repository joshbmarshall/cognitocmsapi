<template>
  <div class="max-w-7xl w-full p-2 mx-auto flex flex-col gap-6">
    <div> <!-- ALERTS, notification blocks to give feedback -->
      <h1 class="text-3xl font-display">Alerts</h1>
    ...
    <div> <!-- FORM INPUTS, all things form related -->
      <h1 class="text-3xl font-display">Form inputs</h1>
      <cgn-form-label label="form label"></cgn-form-label>
      <cgn-form-input label="form input"></cgn-form-input>
      <cgn-form-input placeholder="unlabeled field"></cgn-form-input>
    ...
    <div> <!-- NAVIGATION, for getting around the site -->
      <h1 class="text-3xl font-display">Navigation</h1>
      <span class="text-lg">breadcrumbs</span>
      <cgn-breadcrumb :links="breadcrumbs_dummydata"></cgn-breadcrumb>
      <span class="text-lg">pagination</span>
      <cgn-pagination :pageCount="15" urlPrefix="articles"></cgn-pagination>
    </div>

    <div> <!-- LOGINS, for allowing users to access their accounts -->
      <h1 class="text-3xl font-display">Logins</h1>
      <span class="text-lg">login</span>
      <cgn-login></cgn-login>
      <span class="text-lg">forgot password</span>
      <cgn-forgot-password></cgn-forgot-password>
    </div>

    <div> <!-- MISC, random items that don't fit into a category -->
      <h1 class="text-3xl font-display">Misc</h1>
      <span class="text-lg">cart shipping quote</span>
      <cgn-cart-shipping-quote></cgn-cart-shipping-quote>

      <span class="text-lg">newsletter sign up</span>
      <cgn-newsletter-sign-up></cgn-newsletter-sign-up>

      <span class="text-lg">social sharing</span>
      <cgn-social-share url="/sitelink" title="Absolutely epic demopage!" description="Go test it now!" facebook twitter
        linkedin></cgn-social-share>

      <span class="text-lg">progress bar</span>
      <cgn-progress :progress="32"></cgn-progress>

      <span class="text-lg">spinner icon</span>
      <cgn-spinner></cgn-spinner>
    </div>

    <div> <!-- MODALS and TOASTS, absolute popups used to notify users of something significant -->
      ...
      <cgn-toast v-model="toast_fail_open" type="fail"
        message="you have failed me! You probably did something wrong"></cgn-toast>
      <cgn-toast v-model="toast_success_open" type="success" message="you did it! Congratulations!"></cgn-toast>
    </div>
  </div>
</template>
