<template>
  ...
  >
    <div class="place-content-center min-h-screen pt-4 px-4 pb-20 text-center block sm:p-0">
      ...
      <div
        class="inline-block bg-white rounded-lg overflow-hidden shadow-xl transform w-full my-8 max-w-lg"
      >
        <div
          class="absolute top-0 right-0 w-10 h-10 select-none hover:bg-gray-100 text-lg p-2.5"
          @click="close()"
        >
          <i-heroicons-solid:x />
        </div>
