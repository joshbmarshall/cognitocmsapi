<template>
  <div>
    ...
    <select
      v-model="curval"
      :required="required"
      class="block rounded-md px-2 py-2 w-full shadow-md dark:shadow-inner placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-white dark:bg-slate-600"
      @change="handleInput"
    >
